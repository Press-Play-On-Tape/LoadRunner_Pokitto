...
void Game::clearEnemyMovementPositions(Enemy *enemies) {
...
void Game::enemyMovements(Enemy *enemy) {
...
boolean Game::isOccupiedByAnotherEnemy(Enemy *enemies, Enemy *enemy, int8_t xDelta, int8_t yDelta) {
...
boolean Game::attemptToMove(Enemy *enemy, uint8_t enemyX, uint8_t enemyY, 
                            Direction direction, 
...
void Game::setDirectionAfterHoleEscape(Enemy *enemy) {
...
void Game::move(Enemy *enemy, int8_t x, int8_t y, bool randomMoves) {
...
void Game::updateEnemyStance(Enemy *enemy, PlayerStance lowerRange, PlayerStance upperRange) {
